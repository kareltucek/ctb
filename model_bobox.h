...
namespace ctb
{
  ...
  class model_bobox : public model_generator
  {
    protected:
...
#define ADD(a,b) aliases.insert(aliastab_t::value_type(a,b))
  ...
  std::string model_bobox::get_name()
  {
    return "bobox";
  }
  ...
  void model_bobox::init()
  {
    ...
    ADD("fdeclin",  writer<model_generator>::from_file("templates/bobox_decl_in.h"));
    ADD("fdeclout", writer<model_generator>::from_file("templates/bobox_decl_out.h"));
    ADD("fenvin",   writer<model_generator>::from_file("templates/bobox_env_in.h"));
    ADD("fenvout",  writer<model_generator>::from_file("templates/bobox_env_out.h"));
    ADD("fbox",     writer<model_generator>::from_file("templates/bobox_box.h"));
    ADD("fsend",    writer<model_generator>::from_file("templates/bobox_send.h"));
