...
namespace ctb
{
   ...
   *  - outindent = indent to be applied for the line provided - may differ from the logical indent e.g. typically for case which is one layer to the left from the indent defined by braces.
