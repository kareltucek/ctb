...
%moje pridavky
\newcommand{\expr}[1]{$#1$}
\newcommand{\graph}[1]{\begin{figure}[H]\centering\input{contents/graphs/final/#1}\end{figure}}
%\newcommand{\graph}[1]{\begin{figure}[H]\centering\resizebox{.9\linewidth}{!}{\input{contents/graphs/final/#1}}\end{figure}}
  \newcommand{\graphn}[1]{\begin{sidewaysfigure}\resizebox{1\linewidth}{!}{\input{contents/graphs/final/#1}}\end{sidewaysfigure}}
