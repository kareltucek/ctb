...
namespace ctb
{
  ...
  template <class T, class G, class IT>
    class xml_loader
    {
      ...
      public:
        static void load_graph(G& graph, std::string filename) ;
        static void load_instab(IT& instab, std::string filename) ;
  ...
  template <class T, class G, class IT>
    void xml_loader<T,G,IT>::load_graph(G& graph, std::string filename)
    {
  ...
  template <class T, class G, class IT>
    void xml_loader<T,G,IT>::load_instab(IT& instab, std::string filename)
    {
      using namespace tinyxml2;
      XMLDocument xmlDoc;
      XMLCheckResult(xmlDoc.LoadFile(filename.c_str()));
  ...
  template <class T, class G, class IT>
    void xml_loader<T,G,IT>::self_test()
    {
      ...
      xml_loader l;
      l.load_instab(tab, "xml/instab.xml");
      l.load_graph(g, "xml/graph.xml");
    }
