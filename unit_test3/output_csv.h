...
void test_body()
{
  for(int r = 0;r < 10000;++r)
  {
    ...
    for (int i = 0;i < 100 ;i++)
    {
      ...
      {
        __m128i var_LDI_0_w4_0 = _mm_loadu_si128((const __m128i*)&data_in_2[pos_in_2+j]);
        __m128i var_LDI_1_w4_0 = _mm_loadu_si128((const __m128i*)&data_in_1[pos_in_1+j]);
        __m128i var_ADDI_2_w4_0 = _mm_add_epi32(var_LDI_0_w4_0, var_LDI_1_w4_0);
      ...
      for (;j < batch_size;++j)
      {
        int var_LDI_9_w1_0 = data_in_2[pos_in_2+j];
        int var_LDI_10_w1_0 = data_in_1[pos_in_1+j];
        int var_ADDI_11_w1_0 = var_LDI_9_w1_0 + var_LDI_10_w1_0;
        int var_MULI_12_w1_0 = var_LDI_10_w1_0 * var_LDI_9_w1_0;
        int var_ADDI_13_w1_0 = var_MULI_12_w1_0 + var_ADDI_11_w1_0;
